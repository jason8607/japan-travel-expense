      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            disabled={loading}
            className="w-full h-12 rounded-xl bg-[#06C755] hover:bg-[#05b34d] text-white flex items-center justify-center gap-3 font-medium text-sm transition-colors shadow-sm disabled:opacity-60"
          >
